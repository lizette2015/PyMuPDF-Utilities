...
textrect = pymupdf.Rect(headrect.x0, headrect.y1, headrect.x1, footrect.y0)
leftrect = +textrect
...
tw.fill_textbox(footrect, footer, font=font, align=pymupdf.TEXT_ALIGN_CENTER)
tw.fill_textbox(rightrect, right, font=font, align=pymupdf.TEXT_ALIGN_CENTER)
tw.fill_textbox(leftrect, left, font=font, align=pymupdf.TEXT_ALIGN_CENTER)
tw.fill_textbox(headrect, header, font=font, align=pymupdf.TEXT_ALIGN_CENTER)
tw.write_text(page)
doc.subset_fonts()
